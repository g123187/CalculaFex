...
import br.com.gilmar.calculafex.extensions.format
...
class ResultActivity : AppCompatActivity() {
    ...
    private fun calculate() {
        ...
        tvGasAverageResult.text = (gasPrice / gasAverage).format(digits = 2)
        tvEthanolAverageResult.text = (ethanolPrice / ethanolAverage).toString()
        tvFuelRatio.text = getString(R.string.label_ration_fuel, performanceMyCar.format(digits = 2))
